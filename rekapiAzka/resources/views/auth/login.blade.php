        ...
        <div class="bg-transparen grid grid-cols-1 lg:grid-cols-12 gap-2 max-w-6xl">
            <div class="bg-white satu rounded-lg lg:col-span-7 py-10">
                <div class="p-5 lg:p-10">
                    <div class="pb-5">
                        <h2 class="text-xl font-semibold">Web <span class="text-green-500">Rekapitulasi</span></h2>
                    </div>
                    <div class="pb-10">
                        <h1 class="text-4xl lg:text-6xl font-bold">
                            <span class="border-b border-green-500">Rekap</span><span class="border-b border-black text-green-500">Apps</span>
                        </h1>
                    </div>
                    <div class="pb-10">
            ...
            <div class="dua bg-gray-300 rounded-lg lg:col-span-5 py-10">
                <div class="p-5 lg:p-10">
                    <div class="p-5">
                        <div class="p-2 rounded-lg">
                            <div class="text-center">
                                <h1 class="text-2xl lg:text-4xl font-semibold text-black">Hello<span class="text-green-500">!</span></h1>
                                <p class="font-semibold text-gray-500">Selamat datang di <span class="text-black">Rekap</span><span class="text-green-500">Apps</span>. Silahkan login terlebih dahulu.</p>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="{{ route('login') }}" class="max-w-md mx-auto my-8">
                                    @csrf
                                    <div class="mb-4">
                                        <label for="email" class="block text-sm font-medium text-green-500">{{ __('Email Address') }}</label>
                                    ...
                                    <div class="mb-0">
                                        <button type="submit" class="w-full bg-green-500 text-black p-2 rounded-md">
                                            {{ __('Login') }}
                                        </button>
                                    </div>
                                </form>
