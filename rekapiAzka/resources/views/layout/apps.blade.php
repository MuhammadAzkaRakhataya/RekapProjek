...
<body class="bg-gray-50">
    ...
    <!-- Navbar -->
    <div id="navbar" class="fixed top-0 left-[-270px] bg-green-500 overflow-x-hidden transition duration-500 ease-in-out pt-0 text-black w-64 h-full z-10 shadow-2xl">


        <div class="flex items-center pt-6 pb-10 mx-4 px-4 justify-between">
            <a href="" class="font-semibold text-3xl"><span class="text-black">Rekap</span><span class="text-white">Apps</span></a>

            <!-- Tombol Toggle -->
        </div>


        <div onclick="toggleNavbar()" class="flex items-center py-3 mx-4 px-4 rounded-lg transition duration-300 ease-in-out hover:scale-105 cursor-pointer hover:bg-gray-200">
        ...
        <div class="flex items-center py-3 mx-4 px-4 rounded-lg transition duration-300 ease-in-out hover:scale-105 hover:bg-gray-200" id="navbarToggle">
        ...
        @if (Auth::check())
            @if (Auth::user()->role == "admin")
                ...
                <div class="text-left text-sm mt-2 w-4/5 mx-auto pl-10" id="submenu">
                    <ul>
                        <li class="flex rounded-lg transition duration-300 ease-in-out hover:scale-105 p-3 text-md items-center gap-2 hover:bg-gray-200">
    ...
    <div id="header" class="ml-64 p-5 bg-white flex items-center justify-between z-20 shadow-lg">
        <div class="text-right font-semibold">Welcome, <span class="text-green-500">{{ Auth::user()->name }}</span></div>
            ...
            <div class="justify-end flex items-center">
                <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
                    ...
                    <div class="justify-end">
                        <button type="submit" class=" p-2 rounded-lg text-black font-semibold border bg-green-500">Logout</button>
                    </div>
                </form>
            </div>
        </div>
